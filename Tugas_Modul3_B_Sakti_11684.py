...
st.markdown("""
    ...
    """, unsafe_allow_html=True)
st.markdown("<h1 style='text-align: center; color: #4CAF50;'>Prediksi IPK - 1684</h1>", unsafe_allow_html=True)
...
if uploaded_file is not None:
    ...
    model_directory = r"/Users/saktiyoga/Development/University/Semester 5/PMDPM/Model Suprevised Learning/Tugas3_B_11684"
    model_path = os.path.join(model_directory, r'Lasso_IPK_model.pkl')
